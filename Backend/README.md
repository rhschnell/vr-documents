...
- Create a uploads folder in vr-documents\Backend.
...
- Response: The merged PDF file as a downloadable document.
...
- Response: The extracted pages as a new PDF document.
...
- The server is configured to handle raw PDF data with a limit of 5MB.
