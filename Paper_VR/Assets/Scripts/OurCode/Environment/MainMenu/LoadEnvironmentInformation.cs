...
public class LoadEnvironmentInformation : MonoBehaviour
{
    ...
    /// <returns>The IEnumerator.</returns>
    public IEnumerator LoadScene(EnvironmentController environmentInformation)
    {
        // For-loop with index
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        if (scene.name.Equals("Environment"))
        {
            ...
            EnvironmentController environmentInformation = this.gameObject.GetComponent<EnvironmentController>();
