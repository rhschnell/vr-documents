...
public class ExtractController : MonoBehaviour
{
    ...
    /// </summary>
    public void OnClickExtractSubsection()
    {
        ...
        if (floatingDocument != null && ((end - start + 1) < floatingDocument.pages.Count))
        {
            ...
            var splitPdf = new ExtractPDF(floatingDocument, newFloatingDocument);
            var newPage = splitPdf.ExtractDocument(start, end);
    ...
    /// </summary>
    public void OnClickExtractIndividualPage()
    {
