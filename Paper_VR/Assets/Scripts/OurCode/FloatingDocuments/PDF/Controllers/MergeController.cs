...
public class MergeController : MonoBehaviour
{
    ...
    public void UpdateList()
    {
        if (!this.mergeMenu.activeSelf)
        {
            ...
            var environmentInformation = this.GameManager.GetComponent<EnvironmentController>();
        ...
        {
            // Cancel
            var list = this.GameManager.GetComponent<EnvironmentController>().GetFloatingDocuments();
            foreach (FloatingDocument t in list)
            {
                t.mergeButton.SetActive(false);
            }
