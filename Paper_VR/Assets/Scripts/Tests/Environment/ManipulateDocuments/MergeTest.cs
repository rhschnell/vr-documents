...
/// <summary>
/// A class containing tests for the MergeDocuements class.
/// </summary>
public class MergeTest
{
    ...
    MergeDocuements mergeDocuments;
    ...
    public void Setup()
    {
        ...
        this.mergeDocuments = this.go.AddComponent<MergeDocuements>();
    ...
    public void UpdateListInactive()
    {
        ...
        var environmentInformation = this.gameManager.AddComponent<EnvironmentInformation>();
