...
public class LoadEnvironmentInformationTest
{
    ...
    {
        // Create a GameObject and add the EnvironmentController and LoadEnvironmentInformation components
        GameObject testGameObject = new GameObject("TestGameObject");
        testGameObject.AddComponent<EnvironmentController>();
        ...
        EnvironmentController environmentInformation = testGameObject.GetComponent<EnvironmentController>();
    ...
    public IEnumerator LoadSceneTest()
    {
        ...
        EnvironmentController environment = gameObject.AddComponent<EnvironmentController>();
