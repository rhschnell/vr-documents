...
/// <summary>
/// The testing class for EnvironmentController.
/// </summary>
public class EnvironmentInformationTest
{
    ...
    {
        EnvironmentController envInf = this.CreateObjectEnv();
        envInf.SetName("jan");
    ...
    {
        // Create a GameObject and add the EnvironmentController component to it
        EnvironmentController oldEnvironmentInformation = this.CreateObjectEnv();
        ...
        // Create a new GameObject and add the EnvironmentController component to it
        EnvironmentController newEnvironmentInformation = this.CreateObjectEnv();
        newEnvironmentInformation.docPrefab = docPrefab;

        newEnvironmentInformation.LoadNewInformation(new EnvironmentInformation(oldEnvironmentInformation));
    ...
    /// <summary>
    /// This Test checks if the EnvironmentController can be saved to a JSON file.
    ...
    {
        // Create a GameObject and add the EnvironmentController component to it
        EnvironmentController environmentInformation = this.CreateObjectEnv();
        ...
        // Save the EnvironmentController to a JSON file
        EnvironmentInformation environmentInfo = new EnvironmentInformation(environmentInformation);
        string json = environmentInfo.SaveToJson();

        // Load the EnvironmentController from the JSON file
        EnvironmentInformation loadedEnvironmentInfo = EnvironmentInformation.LoadFromJson(json);

        Debug.Log(json);

        // Create a GameObject and add the EnvironmentController component to it
        EnvironmentController environmentInformation2 = this.CreateObjectEnv();
        environmentInformation2.docPrefab = docPrefab;

        // Load the EnvironmentController to the EnvironmentController component
    ...
    public IEnumerator SaveToDrive()
    {
        ...
        // Save the EnvironmentController to the google drive
    ...
    /// <summary>
    /// This method creates an empty EnvironmentController object.
    /// </summary>
    /// <returns>
    /// An empty EnvironmentController object.
    /// </returns>
    private EnvironmentController CreateObjectEnv()
    {
        // Create a GameObject and add the EnvironmentController component to it
        GameObject gameObject = new GameObject("Environment");
        EnvironmentController environmentInformation = gameObject.AddComponent<EnvironmentController>();
