...
public class SplitDocumentMenuTest
{
    ...
    public void ToggleMenuSimplePass()
    {
        ...
        splitDocumentMenu.ToggleSubsectionMenu();
    ...
    public void OnClickSplitSimplePass()
    {
        ...
        var splitDoc = new GameObject("asd").AddComponent<ExtractController>();
        splitDoc.menuController = splitDocumentMenu;
        splitDoc.pdfPrefab = this.originalPdfCanvas;

        splitDoc.OnClickExtractSubsection();
    ...
    public void OnClickSplitIndividualPageTest()
    {
        ...
        var initialDocumentCount = this.envInfo.GetFloatingDocuments().Count;
        var splitDocument = new GameObject("ExtractController").AddComponent<ExtractController>();
        splitDocument.menuController = splitDocumentMenu;
        splitDocument.pdfPrefab = this.originalPdfCanvas;

        splitDocument.OnClickExtractIndividualPage();
