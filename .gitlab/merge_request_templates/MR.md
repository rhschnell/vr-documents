...
* [ ] Did you fix all StyleCop errors?
* [ ] Did you achieve the definition of done?
* [ ] Are you merging to the right branch?

# Reviewer Checklist
* [ ] Implements the requirement/task fully, and only that requirement/task.
...
* [ ] The Issue contains the spent time, tags and all the boxes are checked.
* [ ] The time tracking report of the MR and Issue makes sense.
...
# How are the changes tested and how can the reviewer test the new changes?
*Please specify how reviewers should test your functionality*  

# How to review
*Leave comments and check the checkboxes in the checklist*
